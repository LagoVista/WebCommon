...
{
    public class LocalHostedServiceDiagnosticsService : ILocalHostedServiceDiagnosticsService
    {
        private readonly IEnumerable<IHostedServiceDiagnostics> _hostedServiceDiagnostics;

        public LocalHostedServiceDiagnosticsService(IEnumerable<IHostedServiceDiagnostics> hostedServiceDiagnostics)
        {
            _hostedServiceDiagnostics = hostedServiceDiagnostics ?? Enumerable.Empty<IHostedServiceDiagnostics>();
        }
